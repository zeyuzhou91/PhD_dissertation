...
class System_PR7_2(PTS.System_PTS): 
    """
    No Survivor Re-balancing + Guided Exploration
    """
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        self.Particles[idx[:die]] = guided_Gaussian_exploration(self, die, mu, 2 * cov) # particles killed and regenerated
        self.w = reweight_without_balancing(self, die, idx)
        return None
...
class System_PR7_3(PTS.System_PTS): 
    """
    No Survivor Re-balancing + Guided Exploration
    """
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        self.Particles[idx[:die]] = guided_Gaussian_exploration(self, die, mu, 3 * cov) # particles killed and regenerated
        self.w = reweight_without_balancing(self, die, idx)
        return None
...
class System_PR7_5(PTS.System_PTS): 
    """
    No Survivor Re-balancing + Guided Exploration
    """
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        self.Particles[idx[:die]] = guided_Gaussian_exploration(self, die, mu, 5 * cov) # particles killed and regenerated
        self.w = reweight_without_balancing(self, die, idx)
        return None
...
class System_PR7_logt(PTS.System_PTS): 
    """
    No Survivor Re-balancing + Guided Exploration
    """
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        self.Particles[idx[:die]] = guided_Gaussian_exploration(self, die, mu, np.log(t) * cov) # particles killed and regenerated
        self.w = reweight_without_balancing(self, die, idx)
        return None
...
class System_PR7a(PTS.System_PTS): 
    ...
    def __init__(self, K, T, Npar):
        super().__init__(K, T, Npar) 
        self.death_weight = 0.001
        self.newborn_weight = 0.01
        self.mu = np.ones(K) 
        self.Sigma = np.ones((K,K))
    ...
    def update_state(self, a, obs, t):
        ...
        (self.mu, self.Sigma) = calculate_empirical_stats(self.w, self.Particles)
    ...
    def update_particles(self, t):
        ...
        for i in range(self.Npar):
            if self.w[i] < (1.0/self.Npar) * self.death_weight:
                self.Particles[i] = guided_Gaussian_exploration(self, 1, self.mu, np.log(t+1) * self.Sigma)
                self.w[i] = (1.0/self.Npar) * self.newborn_weight
...
class System_PR8_logt(PTS.System_PTS): 
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        self.Particles[idx[:die]] = guided_Gaussian_exploration(self, die, mu, np.log(t)*tra*np.eye(self.K)) # particles killed and regenerated
        self.w = reweight_without_balancing(self, die, idx)
        return None
