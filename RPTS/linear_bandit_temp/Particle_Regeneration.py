...
class System_PR1(PTS.System_PTS): 
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        num = int(self.Npar * self.check_frac)  # kill this number of particles
        idx = np.argpartition(self.w, num)  # indices of particles to be killed
        self.Particles[idx[:num]] = aux.generate_uniform_points_in_ball(1, num, self.N)  # particles killed and regenerated
...
class System_PR2(PTS.System_PTS): 
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        self.Particles[idx[:die]] = guided_Gaussian_exploration(self, die, mu, tra*np.eye(self.N))
        self.w = reweight_with_balancing(self)
...
class System_PR6(PTS.System_PTS): 
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        self.Particles[idx[:die]] = guided_Gaussian_exploration(self, die, mu, tra*np.eye(self.N)) # particles killed and regenerated
        self.w = reweight_without_balancing(self, die, idx)
        return None
...
class System_PR7a(PTS.System_PTS): 
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        self.Particles[idx[:die]] = guided_Gaussian_exploration(self, die, mu, self.N * cov) # particles killed and regenerated
        self.w = reweight_without_balancing(self, die, idx)
        return None
...
class System_PR8(PTS.System_PTS): 
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        #print('mu =', mu)
        #print('cov =', cov)
        tra = np.trace(cov) / self.N    # Compared to PR5, adding this 1/k factor
        #print('tra =', tra)  
...
class System_PR9(PTS.System_PTS): 
    ...
    def kill_and_regenerate_particles(self, t):
        ...
        #print('mu =', mu)
        #print('cov =', cov)
        tra = np.trace(cov) / self.N   
        #print('tra =', tra) 
        Sigma = tra*np.eye(self.N)
...
def oblivious_exploration(G, n):
    ...
    Par = aux.generate_uniform_points_in_ball(1, n, G.N)
    return Par
