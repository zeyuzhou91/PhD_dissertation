...
if __name__ == "__main__":
    ...
    fw = open('data/network_slicing_model2_' + str(B[0]) + '_' + str(B[1]) + '_' + str(B[2]) + '_' + alg + '_N' + str(Npar) + '_CUM', 'wb')
    pickle.dump(x, fw)
    fw.close()
    fw = open('data/network_slicing_model2_' + str(B[0]) + '_' + str(B[1]) + '_' + str(B[2]) + '_' + alg + '_N' + str(Npar) + '_AVG', 'wb')
    pickle.dump(y, fw)
    fw.close()
